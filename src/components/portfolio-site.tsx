...
function Contact({ language }: { language: Language }) {
  const contacts = [{ label: text(copy.labels.email, language), value: "tranminhquan.acc@gmail.com", href: "mailto:tranminhquan.acc@gmail.com" }, { label: text(copy.labels.github, language), value: "github.com/micharel09", href: "https://github.com/micharel09" }, { label: "LinkedIn", value: "linkedin.com/in/quân-trần", href: "https://www.linkedin.com/in/qu%C3%A2n-tr%E1%BA%A7n-8b4249372/" }, { label: "Facebook", value: "facebook.com/silentguy", href: "https://www.facebook.com/silentguy/" }, { label: language === "en" ? "Curriculum vitae" : "Hồ sơ năng lực", value: text(copy.action.cv, language), href: "/assets/tran-minh-quan-cv.pdf", download: true }];
